...
<template>
    <div class="w-full px-[180px] py-[60px] flex flex-col">
        <h1 class="text-[32px] font-semibold">Create Personal Account</h1>
        ...
        <div class="w-20">
            <UButton class="w-full bg-secondary hover:bg-secondary  flex-shrink-0" @click="register">Next</UButton>
        </div>
    </div>
</template>